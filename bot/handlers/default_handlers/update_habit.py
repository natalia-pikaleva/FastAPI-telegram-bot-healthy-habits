from bot.keyboards.inline.core import habit_fields_inline, set_repeat_period_inline, confirmation_of_habit_update_inline
...
def process_title_update(message):
    ...
    update_habit_title_request_api(chat_id=chat_id, token=token, title=message.text, habit_id=habit_id)
